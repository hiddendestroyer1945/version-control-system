...
*   **Description**: To explain the types of version controls, types of version control tools, types of git projects and git servers.
...
*   **Git Projects**: Git tool used for two types of git projects. Local git projects and distributed git projects.
    *   **Local Git Projects**: Local git projects are the projects that are stored on the local machine.
    *   **Distributed Git Projects**: Distributed git projects are the projects that are stored on a remote server and local machine.

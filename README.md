...
It's version control system learning repository. This each .md file is explaining specific subject in table of contents.
...
* [Secret Management & Security](version-control-sensetive-data-securing.md)
* [Snippet Management(Gists)](version-control-remembrances-storage.md)
* [VCS Project Lifecycle & Documentation](version-control-project-management.md)
* [Technical Writing with Markdown](version-control-markdown-scripting.md)